...
pygame.mixer.music.load('sounds/mewing.mp3')
...
birdsound3 = pygame.mixer.Sound("sounds/sus.mp3")

screen_width = 996
screen_height = 563

# загружаем картинки
desertbg = pygame.image.load('images/maxresdefault.jpg')
junglebg = pygame.image.load('images/junglebg1.png')
junglegr = pygame.image.load('images/rus.jpg')
skybg = pygame.image.load('images/sky.jpg')
skygr = pygame.image.load('images/ccc.png')
startbg = pygame.image.load('images/startbg.png')
ground_img = pygame.image.load('images/rus.jpg')
...
fon2 = pygame.image.load('images/mew.png')
fon2_jun = pygame.image.load('images/junglessmini.png')
fon2_des = pygame.image.load('images/fon2.png')
...
def second_page():
    ...
    while True:
        ...
        textt(f'ОЧКО Сигмы: {mx[:-1]}', font2, black, 750, screen_height - 50)
    ...
    if number_page == 1:
        ...
        if not game_over and flying:
            ...
            if time_now - last_stolb > stolb_speed:
                stolb_height = random.randint(-50, 50)
